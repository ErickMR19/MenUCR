    ...
    <div class="form-group">
        ...
        ?>
        <input type="date" id="date" name="date" class="form-control" placeholder="Fecha de creación del menú" value = "<?php echo $menusDishesCategory->date->format('Y-m-d') ?>" required>
    </div>
