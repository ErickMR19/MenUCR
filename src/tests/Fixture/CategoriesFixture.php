...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'price' => ['type' => 'float', 'length' => 10, 'precision' => 5, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        ...
        '_constraints' => [
            ...
            'categories_ibfk_1' => ['type' => 'foreign', 'columns' => ['restaurant_id'], 'references' => ['restaurants', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
